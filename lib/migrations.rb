...
class Migrations
  class << self
    ...
    def enhance_licensing_system
      ...
      # Create subscription_billing_history table for payment tracking
      DB.create_table :subscription_billing_history do
        primary_key :id
    ...
    def seed_billing_cycles
      cycles = [
        ...
        { name: 'semi_monthly', display_name: 'Semi-Monthly (Every 2 weeks)', days: 14, stripe_interval: 'week', stripe_interval_count: 2 },
        { name: 'monthly', display_name: 'Monthly', days: 30, stripe_interval: 'month', stripe_interval_count: 1 },
        { name: 'tri_monthly', display_name: 'Tri-Monthly (Every 3 months)', days: 90, stripe_interval: 'month', stripe_interval_count: 3 },
        { name: 'semi_annually', display_name: 'Semi-Annually (Every 6 months)', days: 182, stripe_interval: 'month', stripe_interval_count: 6 },
